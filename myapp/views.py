...
from realestateonline.settings import DATE_INPUT_FORMATS, EMAIL_FROM
...
def thanks(request, id=0):
    if request.method == "POST":
        ...
        getcontext().prec = 10
        total = (prop.dailyRate * form['dateFrom'].value().__len__())
        ...
        # SENDING EMAIL
        subject = 'Su reserva en Real-Estate Online ha sido realizada exitosamente'
